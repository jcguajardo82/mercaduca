...
namespace WebMvc.Menu
{
    ...
    public class CheckSessionOutAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            //if (filterContext.HttpContext.Request.Cookies.AllKeys.Contains("CookieLoginMovil"))
            //{
            ...
            //        HttpCookie cookieO = new HttpCookie("CookieLoginMovil");
            ...
            //        cookieO["IdSistema"] = "18";
            //        cookieO["Navegador"] = "Other";
            ...
            //    else
            //    {
            //        //if (this.ControllerContext.HttpContext.Request.Cookies.AllKeys.Contains("CookieLoginMovil"))
            //        //{
            //        //    HttpCookie cookie = this.ControllerContext.HttpContext.Request.Cookies["CookieLoginMovil"];
            ...
            {
                cookie = filterContext.HttpContext.Request.Cookies["CookieLoginMovil"].Value;
                ...
                else
                {
                    ...
                    string userId = filterContext.HttpContext.Request.Cookies["CookieLoginMovil"]["UserId"];
                    string idSistema = filterContext.HttpContext.Request.Cookies["CookieLoginMovil"]["IdSistema"];

                    string user = Soriana.FWK.Seguridad.HelperEncriptar.Desencriptar(filterContext.HttpContext.Request.Cookies["CookieLoginMovil"]["User"]);
                    string pass = Soriana.FWK.Seguridad.HelperEncriptar.Desencriptar(filterContext.HttpContext.Request.Cookies["CookieLoginMovil"]["Pass"]);
                    ...
                    System.Web.HttpContext.Current.Session["Navegador"] = filterContext.HttpContext.Request.Cookies["CookieLoginMovil"]["Navegador"];
                    System.Web.HttpContext.Current.Session["App"] = "Mercancia Por Caducar Movil";

                    System.Web.HttpContext.Current.Session["urlLogin"] = srvName + ConfigurationManager.AppSettings["Login"].ToString() + ConfigurationManager.AppSettings["HomeLogin"].ToString() + string.Format("?user={0}&pass={1}", filterContext.HttpContext.Request.Cookies["CookieLoginMovil"]["User"].ToString(), filterContext.HttpContext.Request.Cookies["CookieLoginMovil"]["Pass"].ToString());
    ...
    public class AuthorizationPrivilegeFilter : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            if (System.Configuration.ConfigurationManager.AppSettings["flagTypeConection"].Trim().Equals("Y"))
            {
                string userIni = Soriana.FWK.Seguridad.HelperEncriptar.Desencriptar(filterContext.HttpContext.Request.Cookies["CookieLoginMovil"]["User"]);
                string passIni = Soriana.FWK.Seguridad.HelperEncriptar.Desencriptar(filterContext.HttpContext.Request.Cookies["CookieLoginMovil"]["Pass"]);
